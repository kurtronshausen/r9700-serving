...
# NOTE: Overlay of aiter/jit/utils/torch_guard.py from AITER_REF=v0.1.19.post2,
# mounted read-only into the runtime image (see compose.yaml). aiter registers
# ops by passing a namespace-prefixed name (`aiter::{opname}`) to a
