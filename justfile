...
# Model profile: "qwen3.6-27b" (default) or "qwen3.6-35b-a3b".
# Selects env/${model}.env for model-specific server arguments.
# Override with `just --set model qwen3.6-35b-a3b <recipe>` or
# `MODEL_PROFILE=qwen3.6-35b-a3b just <recipe>`.
model := env_var_or_default('MODEL_PROFILE', 'qwen3.6-27b')
