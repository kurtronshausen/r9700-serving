...
| file | contents |
|:-----|:---------|
| [`benchmarks/2026-08-28_qwen3.8-flash-next_43389_moe_patch_bench.md`](benchmarks/2026-08-28_qwen3.8-flash-next_43389_moe_patch_bench.md) | Qwen3.8-Flash-Next A/B: vllm#43389 MoE int4 interleave patch — pp2048 ~3x (700-780 -> 2344-2346 t/s), tg unchanged, ctx ceiling 262144 -> ~158304 |
| [`benchmarks/2026-08-28_qwen3.8-flash-next_53899_h2d_patch_bench.md`](benchmarks/2026-08-28_qwen3.8-flash-next_53899_h2d_patch_bench.md) | Qwen3.8-Flash-Next A/B: vllm#53899-review async_tensor_h2d patch for PLE ShortConv metadata — no measurable win on gfx1201 (within noise), kept as correctness fix |
| [`benchmarks/2026-08-28_qwen3.8-flash-next_cudagraph_decode_only_bench.md`](benchmarks/2026-08-28_qwen3.8-flash-next_cudagraph_decode_only_bench.md) | Qwen3.8-Flash-Next A/B: CUDA graphs (mode:0 + cudagraph_mode=FULL_DECODE_ONLY, no torch.compile) — tg32 18.26 -> 74.07 t/s (~4.0x), tg128 15.07 -> 69.68 t/s (~4.4x); torch.compile itself still OOMs on Inductor compile/autotune scratch regardless of tuning |
